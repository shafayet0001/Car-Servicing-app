...
public class CarOwnerProfileActivity extends AppCompatActivity {
    private TextView profileName, profileEmail, profileUsername, profilePhone,profileCar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_owner_profile);
        auth = FirebaseAuth.getInstance();
        currentUserId = auth.getCurrentUser().getUid();
        ProfileUserRef = FirebaseDatabase.getInstance().getReference().child("Users").child("CarOwner").child(currentUserId);
        ...
        profileCar = (TextView) findViewById(R.id.profileCar);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists())
                {
                   ...
                   // String TitleUsername = snapshot.child("username").getValue().toString();
                    ...
                    String ProfileCar = snapshot.child("car").getValue().toString();
        ...
        editProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CarOwnerProfileActivity.this,CarOwnerEditProfileActivity.class));
        ...
        Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(CarOwnerProfileActivity.this,CarOwnerMapsActivity.class));
